...
#include "MultiPlayerGameCPP/MultiPlayerGameCPP.h"
...
/** Console command
*/
FAutoConsoleVariableRef CVARDebugWeaponDrawing(TEXT("MultiPlayerGame.DebugWeapons"), DebugWeaponDrawing, TEXT("Draw Debug Lines for Weapons: 0 - hidden 1 - visible"), ECVF_Cheat);
/*
...
void AWeapon::Fire()
{
	if (!HasAuthority()) // if is a Clien ask server to do it
	{
		ServerFire();
	}
